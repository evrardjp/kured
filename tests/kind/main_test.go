...
func TestE2EWithCommand(t *testing.T) {
	...
	for _, version := range kindClusterConfigs {
		...
		t.Run(version, func(t *testing.T) {
			...
			k := NewKindTester(kindClusterName, kindClusterConfigFile, t, LocalImage("kured:latest"), Deploy("../../kured-rbac.yaml"), Deploy("testfiles/kured-ds.yaml"))
			defer k.FlushLog()
...
func TestE2EWithSignal(t *testing.T) {
	...
	for _, version := range kindClusterConfigs {
		...
		t.Run(version, func(t *testing.T) {
			...
			k := NewKindTester(kindClusterName, kindClusterConfigFile, t, LocalImage("kured:latest"), Deploy("../../kured-rbac.yaml"), Deploy("testfiles/kured-ds-signal.yaml"))
			defer k.FlushLog()
...
func TestE2EConcurrentWithCommand(t *testing.T) {
	...
	for _, version := range kindClusterConfigs {
		...
		t.Run(version, func(t *testing.T) {
			...
			k := NewKindTester(kindClusterName, kindClusterConfigFile, t, LocalImage("kured:latest"), Deploy("../../kured-rbac.yaml"), Deploy("testfiles/kured-ds-concurrent.yaml"))
			defer k.FlushLog()
...
func TestCordonningIsKept(t *testing.T) {
	...
	for _, version := range kindClusterConfigs {
		...
		t.Run(version, func(t *testing.T) {
			...
			k := NewKindTester(kindClusterName, kindClusterConfigFile, t, LocalImage("kured:latest"), Deploy("../../kured-rbac.yaml"), Deploy(manifest))
			defer k.FlushLog()
